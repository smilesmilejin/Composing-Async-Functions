// in module, we need to use import axios?
...
const getRandomDogImage = async () => {
  ...
  const breed = getRandomValue(breeds); // does not need await, since it is not promise object
  const url = await getRandomImageForBreed(breed);
...
// console.log(getRandomDogImage()); //Promise { <pending> }Promise { <pending> }
getRandomDogImage();